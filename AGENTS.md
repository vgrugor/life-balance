...
- There is no automated test suite. For behavior changes, manually check the relevant browser flow, including a reload with saved data. For PWA or path changes, also build with `BASE_PATH=/life-balance/ npm run build`.
